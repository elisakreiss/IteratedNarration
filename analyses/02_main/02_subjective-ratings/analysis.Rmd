...
mh_all = lmer(author_belief ~ as.numeric(generation)*condition + ResidualHedgProp*condition  + (1|story_reproduction), data=df_model)
summary(mh_all)
...
mh_all = lmer(suspect_committedCrime ~ as.numeric(generation)*condition + ResidualHedgProp*condition  + (1|story_reproduction), data=df_model)
summary(mh_all)
