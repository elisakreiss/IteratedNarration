...
\subsection{Methods}
74 undergraduate students participated in this online study for course credit\footnote{\ek{Students were offered several studies they could choose from.}}. 
...
\textbf{Proportion of hedges.} As a proxy for vagueness, we extracted the number of hedges per story relative to its length. The seed stories were designed to contain various hedges, such as "nearly", "about", "up to" or "allegedly". As shown in Figure \ref{fig:corpusLingMetrics}, the proportion of hedges decreased in each generation  ($\beta = -0.01$, $SE = 0.00$, $t = -4.16$, $p < 0.0001$) \ek{statistical analysis \#1 in R script}, suggesting that participants portrayed the stories with more certain language over generations. There was no significant effect of evidence condition on proportion of hedges \ek{statistical analysis \#2 in R script}.
...
\textbf{Preliminary discussion.} It seems \ek{prima facie -- intuitively?} plausible that trust in the author, the subjective quality of the story, or the reader's emotional engagement with the story are important factors in readers' assessment of the described suspects' guilt. But the presented data suggest otherwise. \ek{"The guilt related measures are entirely uncorrelated with the secondary measures." -- We did an analysis for each question that didn't show a strong correlation between any of the guilt related measures and the secondary ones. Is that enough to justify this or do I need to  collapse them somehow for a comparison? Or do we just want to make this claim less strong?} The evidence strength effect was expected, given the strong manipulation in the final sentence of the seed story. However, what is it that changes over generations that affects the guilt related measures in the strong and weak evidence conditions differently? What changes is the content of the stories. We next report a second set of analyses  in which we assess the extent to which the linguistic features reported in Exp.~1 predict ratings in Exp.~2, focusing on the readers' assessment of suspect guilt and of attributed suspect guilt.
