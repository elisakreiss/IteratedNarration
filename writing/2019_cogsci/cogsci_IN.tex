...
We observed significant interactions between evidence strength condition and generation-residualized linguistic feature for two of the three linguistic features for suspect guilt (hedge proportion: $\beta = -79.57$, $SE = 54.05$, $t = -1.47$, $p < 0.15$, story length: $\beta = -0.18$, $SE = .06$, $t = -2.93$, $p < .01$, Jaccard distance: $\beta = 29.52$, $SE = 10.82$, $t = 2.73$, $p < .01$)
%\ek{statistical analysis \#7 in R script}
 and all three linguistic features for attributed suspect guilt (hedge proportion: $\beta = -115.82$, $SE = 58.46$, $t = -1.98$, $p < .05$, story length: $\beta = -0.30$, $SE = .07$, $t = -4.38$, $p < .0001$, Jaccard distance: $\beta = 33.43$, $SE = 11.80$, $t = 2.83$, $p < .01$)
% \ek{statistical analysis \#6 in R script}
. 

Simple effects analysis revealed no evidence of an effect of the linguistic metrics in the strong evidence condition for the two measures. 
However, in the weak evidence condition, as can be seen in Figure \ref{fig:lingmarkers}, an increased number of words was associated with a decrease in both suspect guilt and attributed suspect guilt. An increased proportion of hedges was also associated with a decrease in attributed suspect guilt ratings. Conversely, increased Jaccard distance was associated with an increase in both guilt measures. Inspecting the beta coefficients suggests that these effects are always stronger for attributed suspect guilt than for suspect guilt. 
...
We also observed effects of generation, which we found to be attributable to the ways the reproduced stories changed over generations. We find that contrary to pessimistic expectations it did not appear to be the case that repeated reproductions of stories with nuanced degrees of evidential information would have dropped these nuances, e.g., to arrive at a black-and-white picture. Instead of increasing ratings for strength of evidence in the weak evidence conditions, we rather see a decline of perceived evidential strength over generations in the strong evidence condition. Reproducers seemed to have been rather careful in their formulations, despite the observed decrease in the proportion of hedges.

Most interesting is the relationship between how likely readers think that the suspect is in fact guilty and which belief they attribute to the author of the story in this regard. When the presented evidence is strong, these two ratings align. However when the evidence is weak, these ratings diverge. Crucially, they believe that the suspect is more likely to be guilty than the author appears to believe. It is worth noting that the stories did not contain any information about the author and none of the reproductions contained first person narrations. Therefore readers did not receive direct evidence to support the idea that the author's beliefs should differ from the presented view. The more dissimilar the reproductions become from the original story, the more these two ratings align. They converge onto the highest guilt ratings in the weak condition. These results indicate that the stories are changed in a way that integrate the readers' belief about the suspects' guilt. 
The difference in ratings between the two measures is most borne out, the higher the proportion of hedges in the story is. When the proportion of hedges is minimal, the difference in ratings disappears. This could be an indication that in case of uncertainty, hedges are rather interpreted as information regarding the author's beliefs about the story instead of communicating uncertainty about the event itself.

These findings are promising first analyses of an interestingly structured text corpus, with rich empirically obtained information on readers' assessments of the individual texts. This dataset enables more detailed linguistic analyses in future work\footnote{We will make the corpus publicly available by January 2020 as part of a Github repository which will be available at https://github.com/elisakreiss/iteratednarration.}. 
Future work will look more closely at the more specific contribution of different types of hedges and other types of constructions that signal information about graded evidence.
