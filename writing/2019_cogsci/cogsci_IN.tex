...
\enumsentence{\textbf{Strength of evidence:} How strong is the evidence for the suspect's / suspects' guilt?\label{q1}}
\vspace{-.5cm}
\enumsentence{\textbf{Suspect guilt:} How likely is it that the suspect is / the suspects in the crime are guilty?\label{q2}}
\vspace{-.5cm}
\enumsentence{\textbf{Suspect conviction:} How likely is a conviction of the suspect(s) in the crime?\label{q3}}
\vspace{-.5cm}
\enumsentence{\textbf{Suspect conviction justified:} How justified would a conviction of the suspect(s) in the crime be?\label{q4}}
\vspace{-.5cm}
\enumsentence{\textbf{Author's belief in guilt:} How much does the author believe that the suspect is guilty?\label{q5}}
\vspace{-.5cm}
\enumsentence{\textbf{Trust in author:} How much do you trust the author?\label{q6}}
\vspace{-.5cm}
\enumsentence{\textbf{Subjectivity of story:} How objectively / subjectively written is the story?\label{q7}}
\vspace{-.5cm}
\enumsentence{\textbf{Reader's emotional engagement:} How affected do you feel by the story?\label{q8}}
