...
\title{I heard they might be guilty, so they probably are: Uncertain evidence statements and guilt perception in
  iterative reproductions of crime stories \ek{can we still change this?}}
...
We observed significant interactions between evidence strength condition and generation-residualized linguistic feature for \ek{two of the three linguistic features} for both attributed suspect guilt (hedge proportion: $\beta = -115.82$, $SE = 58.46$, $t = -1.98$, $p < .05$, story length: $\beta = -0.30$, $SE = .07$, $t = -4.38$, $p < .0001$, Jaccard distance: $\beta = 33.43$, $SE = 11.81$, $t = 2.83$, $p < .01$ \ek{<- this was previously non-significant}) and suspect guilt (hedge proportion: $\beta = -79.57$, $SE = 54.05$, $t = -1.47$, $p < 0.15$ \ek{<- this was previously significant}, story length: $\beta = -0.18$, $SE = .06$, $t = -2.93$, $p < .01$, Jaccard distance: $\beta = 29.52$, $SE = 10.82$, $t = 2.73$, $p < .01$) \ek{<- this was previously non-significant}. 
