...
\ek{- we conducted a linguistic analysis to link the ratings to linguistic features that matter on top of the generation. We showed that the \textit{author's belief in guilt} and the reader's belief about \textit{suspect guilt} are strongly influenced by the proportion of hedges used in the stories. We show that when we're provided with only weak evidence, the use of hedges rather influences our beliefs about the author and less our own (which can then be propagated throughout generations, again changing the story more into something that speaks for our own beliefs and therefore the suspect's guilt --> in other words if a reader learns more about the author than the objective guilt from the proportion of hedges, they might not be effective for communicating vagueness in an event ? ). These results provide further insight in the psychological and linguistic interface that shapes reproductions (the information that is transmitted) and the value of obtaining independent interpretation judgments to track subtle changes across reproductions.}
\ek{Promising first step to open the door for further investigations of the linguistic nature of interpretation judgment develpments in iterated narration.}
