...
\setlength{\belowcaptionskip}{-10pt} % standard is 0pt
\setlength{\abovecaptionskip}{-3pt} % standard is 0pt
...
Transmission of information is a lossy process. Here we present the results of a two-step iterated narration study: first, we collected a corpus of 250 crime story reproductions that were produced in parallel reproduction chains of 5 generations in depth, for 5 different seed stories. In a separate large-scale experiment, we collected judgments for each story regarding the guilt of the suspect in the crime. Crucially, strength of evidence for the suspect's guilt was manipulated in the seed stories. Across generations, guilt judgments decreased when the evidence was originally strong, but remained stable when evidence was originally weak. Analysis of linguistic measures revealed that dissimilarity between a seed story and its reproduction, story length, and amount of hedging language affected judgments of suspect guilt and judgments of the author's belief in the suspect's guilt differently. The results provide evidence that \jd{someone with a not fried brain, please end this sentence.}

\textbf{Keywords:} 
experimental pragmatics; iterated narration; transmission chains; crime stories
\end{abstract}
...
\textbf{Generation and evidence strength effects on guilt related measures.} We observed  strong main effects of condition on all guilt related measures (see first 5 panels of Figure \ref{fig:exp2results}), such that ratings in the strong condition were higher than ratings in the weak condition, suggesting that participants in Exp.~1 were sensitive to the evidence strength manipulation (reproducing stories in such a way that evidence strength information was maintained); and also suggesting that participants in Exp.~2 were sensitive to the reproduced evidence strength information in their judgments. %We also observed main effects or marginal main effects of generation on all 5 guilt related measures, such that ratings decreased across generation. 
...
\textit{Trust in author} and the \textit{reader's emotional engagement} did not show a main effect of condition, but of generation. The further it gets from the original seed, the less trust the readers have in the author and the less emotional engagement the readers feel.
...
%\textbf{But what explains the effects on generations for the different measures?} To evaluate this question, we compared the model predictions of the reported model (see Table \ref{tab:exp2results}) which only considered the interaction of condition and generation with a model that additionally considers the proportion of hedges, the Jaccard distance or the length of the story. For each question, we investigate whether adding one of the mentioned metrics results in a significant and therefore justified increase in model complexity, using a Chi-squared ANOVA test.\\
%\textbf{Hedges} Adding the proportion of hedges to the mixed effects model shows a marginal effect for the conviction of the suspect (\ek{...}) and a main effect for the judgments on whether the author believes that the suspect is guilty (\ek{...}). An increase in hedges results in higher ratings that the suspect will be convicted and in higher judgments on whether the author seems to believe that the suspect is guilty \ek{right?}.\\
%\textbf{Distance} significant in author belief in guilt, trust in author, reader's emotional engagement\\
%\textbf{Length} significant in evidence, suspect guilt, author belief in guilt, trust in author and marginal for suspect conviction

In this second part of the analysis, we focus on the measures of \textit{suspect guilt} and \textit{author's belief in guilt}. In the first case, we ask for the participant's personal judgments on whether the suspect is guilty, whereas in the second case we ask about the participant's belief about what the author of the story believes. We will now analyze the differences between these two measures by specifically investigating the impact of length, Jaccard distance and proportion of hedges \ek{see results in 1}.
