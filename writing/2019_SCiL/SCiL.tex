...
In their introduction of the corpus, \citeauthor{Kreiss:2019}\ also examine how guilt ratings are affected by the interaction between the proportion of hedges and the evidence condition. They find the same qualitative patterns in the corpus that the model predicts for the carefully reconstructed seed stories. Interestingly, they merely find a trend and not a statistically significant interaction between proportion of hedges and evidence condition on the guilt judgment, i.e., the truth of the proposition. However, they do find the interaction effect for the ratings on what the reader believes the speaker thinks about the suspect's guilt, i.e., the relationship between the propositional content and the speaker. Our model results and the corpus investigation in \citeauthor{Kreiss:2019}\ agree that hedges affect the perceived uncertainty about (the speaker's belief in) guilt. But it opens questions about how the different kinds of hedges affect the ratings of guilt and speaker's belief in guilt.
