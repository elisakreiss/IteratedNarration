...
% \subsection{work on predicting guilt}
...
% \subsection{work on how people understand markers of (un)certainty}
% \paragraph{markers of uncertainty -- names and definitions}
...
% \paragraph{work on how people understand markers of (un)certainty}

% Giving clear definition is hard.
...
% \citeauthor{prince1982hedging} argues that uncertainty markers can make things ``fuzzy'' \citep{lakoff1972hedges} in two different ways. They either introduce uncertainty ``within the propositional content'' (approximators -- e.g., His feet were \textbf{sort of} blue.), or ``in the relationship between the propositional content and the speaker'' (shields -- e.g., \textbf{I think} his feet were blue.). 
...
% a lot of variation in results of studies; context dependence; individual variation 
% Additionally, the position where hedges occur and whether they are professional or colloquial affects whether people perceive a proposed policy as positive or negative \citep{durik2008effects}. 
% Furthermore, the interpretation of hedges is highly context dependent \citeauthor{bonnefon2006tactful,ferson2015natural}. E.g., the politeness can interact with the probability assessment of the event (possibly insomnia vs. possibly deaf) \ek{elaborate}.
...
% % hedges decrease author credibility (and potentially also acceptance of proposition)
...
% % hedges as a cue to predict deception (rather author based I think)
...
% % position and formality of hedges influence evaluations of proposition
...
% % hedging increases trustworthiness of author
...
% % hedging as a matter of politeness (interaction between author and proposition)
...
% % considerable inter-individual variation when assessing epistemically modalized/hedged language
% Rubin 2007: dataset consisting of news articles; human annotators; shades of certainty in epistemically modalized statements (such as probability and possibility) are highly subjective and present difficulties in manual annotation; considerable inter-individual variation
% Ferson 2015: considerable inter-individual variation (just like in Rubin 2007) when interpreting approximators; those patterns were strongly modulated e.g., by magnitude of the number and roundness.

% \subsection{work on interpreting neural networks to gain linguistic insights}
